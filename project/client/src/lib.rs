...
///     -getter for query res for serch on content web_server
...
///         We will have assets inside the git repo, for web_server holding, instead for client media save
...
///     - Strongly codependant on servers so we hope to have a good web_server end;
///  GUI:
///     -bevy dependency
